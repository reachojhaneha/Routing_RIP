...
QuaggaHost = namedtuple("QuaggaHost", "name ip DG")
net = None
...
class QuaggaTopo(Topo):
    ...
    def __init__(self):
        ...
        quaggaHosts = []
        quaggaHosts.append(QuaggaHost(name='H1', ip='192.168.101.128/24', DG='via 192.168.101.1'))
        ...
        quaggaHosts.append(QuaggaHost(name='H2', ip='192.168.106.128/24', DG='via 192.168.106.1'))
